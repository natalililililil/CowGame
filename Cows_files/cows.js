var kBoardWidth = 9; //игра 9 на 9
var kBoardHeight = 9;
var kPieceWidth = 50; //длина одной €чейки
var kPieceHeight= 50;
var kPixelWidth = 1 + (kBoardWidth * kPieceWidth); //прорисовать сбоку пол€
...
function drawPiece(p, selected) {
    ...
    //alert(cow.width);
    //gDrawingContext.fillStyle = cowPattern;

    gDrawingContext.stroke();
   
    //alert(cow.width);
    gDrawingContext.drawImage(cow, column * kPieceWidth, row * kPieceHeight, 50, 50);
    //gDrawingContext.fillRect(0, 400, );
    //gDrawingContext.fill();
    if (selected) {
        gDrawingContext.fillStyle = "#fff";
        //gDrawingContext.fillStyle = "cowImage.jpg";
	    gDrawingContext.fill();
    }
}
...
function initGame(canvasElement, moveCountElement) {
    ...
    cow = document.getElementById("cowImage");
    //cow = new Image();
    //cow.src = "Cows_files/cowImage.png";
